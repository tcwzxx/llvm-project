...
; CHECK-NEXT:    [[TMP0:%.*]] = trunc i64 [[AND_1_I]] to i1
; CHECK-NEXT:    [[TMP1:%.*]] = insertelement <8 x i1> <i1 poison, i1 false, i1 false, i1 false, i1 false, i1 false, i1 false, i1 false>, i1 [[TMP0]], i32 0
; CHECK-NEXT:    [[TMP2:%.*]] = mul <8 x i1> [[TMP1]], zeroinitializer
; CHECK-NEXT:    [[AND_1_I_1:%.*]] = and i64 0, 0
; CHECK-NEXT:    [[TMP3:%.*]] = trunc i64 [[AND_1_I_1]] to i1
; CHECK-NEXT:    [[TMP4:%.*]] = insertelement <8 x i1> <i1 poison, i1 false, i1 false, i1 false, i1 false, i1 false, i1 false, i1 false>, i1 [[TMP3]], i32 0
...
; CHECK-NEXT:    [[TMP11:%.*]] = call i1 @llvm.vector.reduce.or.v8i1(<8 x i1> [[TMP5]])
; CHECK-NEXT:    [[TMP12:%.*]] = zext i1 [[TMP11]] to i32
; CHECK-NEXT:    [[OP_RDX:%.*]] = or i32 [[TMP9]], [[TMP12]]
